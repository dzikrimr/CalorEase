...
const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-[var(--primary-50)] via-[var(--primary-100)] to-[var(--primary-200)] relative overflow-hidden">
      <div className="flex max-w-6xl w-[85%] gap fractional items-center justify-center relative z-10">
        {/* Register Container */}
        <div className="flex-1 max-w-[450px] bg-[rgba(255,255,255,0.95)] p-8 rounded-2xl shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 backdrop-blur-2xl border border-[rgba(255,255,255,0.8)]">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-[var(--primary-800)] mb-2">Daftar Sekarang</h2>
            <p className="text-[var(--primary-700)] text-base">Buat akun CalorEase Anda</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6 relative group">
              <label htmlFor="confirm-password" className="block mb-2 text-[var(--primary-700)] font-semibold text-base">
                Konfirmasi Password
              </label>
              <div className="relative w-full border-2 border-[var(--primary-200)] rounded-2xl bg-[var(--primary-50)] focus-within:border-[var(--primary-500)] focus-within:bg-white focus-within:shadow-[0_0_0_4px_rgba(31,169,141,0.1)] focus-within:-translate-y-0.5 focus-within:scale-[1.02] transition-all duration-300">
                <input
                ...
                >
                  <Image
                    src={showConfirmPassword ? '/icons/eye-closed.png' : '/icons/eye-open.png'}
            ...
            >
              <span className="relative z-10">{isSubmitting ? 'Mendaftar...' : 'Daftar ke CalorEase'}</span>
          ...
          <div className="text-center my-8 relative text-[var(--primary-700)]">
            <span className="relative bg-[rgba(255,255,255,0.95)] px-4 rounded-full py-2 z-10">atau</span>
            <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[var(--primary-200)] to-transparent z-0"></div>
          </div>
